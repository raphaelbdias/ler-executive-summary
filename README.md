...
- If your repo is published as `https://<user>.github.io/ler-executive-summary/`, the config already sets `basePath/assetPrefix` to `/ler-executive-summary` in CI (`GITHUB_ACTIONS`).
